...
import MobileContactModal from './MobileContactModal/MobileContactModal';
...
const Header = () => {
  ...
  const TopMenu = () => {
    ...
    const handleOpenContactModal = (type: string, info: string) => {
      setContactType(type);
      setContactInfo(info);
          ...
          <div className="container mx-auto flex flex-wrap justify-between items-center">
            <div className="text-sm flex items-center space-x-4">
              <div className="flex items-center">
                <FaEnvelope className="mr-2 hidden md:block" />
                <FaEnvelope
                  onClick={() => handleOpenContactModal('E-mail', 'joelmalimadv@gmail.com')}
                  className="mr-2 md:hidden block"
                  />
                <span className="hidden md:inline">joelmalimadv@gmail.com</span>
              </div>
              <div className="flex items-center">
                <FaPhoneAlt className="mr-2 hidden md:block" />
                <FaPhoneAlt
                  onClick={() => handleOpenContactModal('Telefone', '31995792679')}
                  className="mr-2 md:hidden block"
                />
                <span className="hidden md:inline">(31) 99579-2679</span>
              </div>
              <div className="flex items-center">
    ...
    <header className="fixed w-full top-0 z-50 transition-all duration-300">
      ...
      <div className={`py-0 md:py-1 px-4 sm:px-6 lg:px-8 main-menu transition-all duration-300 ${isScrolled || isOpen ? 'bg-white shadow-md scrolled' : 'bg-transparent'}`}>
        <div className="container mx-auto py-4 flex items-center justify-between">
          <a href="/" className={`logo py-2 font-bold text-xl transition-colors duration-300 ${isScrolled || isOpen ? 'text-black' : 'text-white'}`}>
      ...
      >
        <div className="menu-mobile md:hidden bg-white shadow-md">
